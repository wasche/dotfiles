...
" new html 5.0 tags
syn keyword htmlTagName contained command datalist details output progress
syn keyword htmlTagName contained meter time ruby rt rp article aside header
syn keyword htmlTagName contained hgroup footer section nav figure
syn keyword htmlTagName contained figcaption mark summary
...
" html 5.0 arg names
syn keyword htmlArg contained noValidate pattern placeholder autofocus required
syn keyword htmlArg contained media ping scoped async reversed target
